---
name: sync-docs
description: Sync docs/ and .claude/ after code changes. Use after modifying src/, adding features, or changing APIs. Keeps ARCHITECTURE.md, GAP_ANALYSIS.md, ROADMAP.md, DEVELOPMENT.md, CLAUDE.md, and skills in sync with the code.
...
| `docs/SESSION_TRANSFER.md` | Session/build infrastructure changes |
| `docs/SESSION_TRANSFER_v1.9.0.md` | (version-specific, update as needed) |
...
wc -l src/core/*.rs src/isar/*.rs src/hol/*.rs src/tools/*.rs src/theory/*.rs
